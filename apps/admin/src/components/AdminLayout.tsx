...
const NAV_ITEMS = [
  ...
  { to: '/dashboard/content', label: 'Content', icon: ContentIcon },
  { to: '/dashboard/interests', label: 'Interests', icon: InterestsIcon },
  { to: '/dashboard/bots', label: 'Bots', icon: BotIcon },
  { to: '/dashboard/reports', label: 'Reports', icon: ReportsIcon },
  { to: '/dashboard/marketplace', label: 'Marketplace', icon: MarketplaceIcon },
  { to: '/dashboard/sponsored', label: 'Sponsored', icon: SponsoredIcon },
  { to: '/dashboard/audit-log', label: 'Audit Log', icon: AuditLogIcon },
  { to: '/dashboard/analytics', label: 'Analytics', icon: AnalyticsIcon },
  { to: '/dashboard/sessions', label: 'Sessions', icon: SessionsIcon },
  { to: '/dashboard/broadcast', label: 'Broadcast', icon: BroadcastIcon },
  { to: '/dashboard/system', label: 'System', icon: SystemIcon },
];
...
function InterestsIcon({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
