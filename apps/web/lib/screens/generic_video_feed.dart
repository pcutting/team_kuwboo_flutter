...
/// Generic TikTok-style video feed — parameterized by colors + nav widget.
/// Used by designs that don't have a custom video_feed.dart.

class GenericVideoFeed extends StatelessWidget {
  final Color primary;
  final Color secondary;
  final Color text;
  final Widget bottomNav;

  const GenericVideoFeed({
    super.key,
