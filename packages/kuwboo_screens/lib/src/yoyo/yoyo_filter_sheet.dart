...
const _allInterests = [
  'hiking', 'tech', 'beer', 'music', 'design', 'coffee',
  'photography', 'nature', 'cooking', 'wine', 'travel',
  'yoga', 'reading', 'art',
];
              ...
              children: [
                ...
                _FilterSection(
                  ...
                  _FilterSection(
                    ...
                    child: Row(
                      children: [
                        for (final label in ['all', 'friends', 'family', 'strangers']) ...[
                ...
                _FilterSection(
                  ...
                  child: Wrap(
                    ...
                    children: _allInterests.map((interest) {
                      final isSelected =
                          state.yoyoSelectedInterests.contains(interest);
                      return ProtoPressButton(
                        duration: const Duration(milliseconds: 100),
                        onTap: () {
                          final updated =
                              Set<String>.from(state.yoyoSelectedInterests);
                          if (isSelected) {
